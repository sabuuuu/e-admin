...
function AjouterSalle() {
  ...
  const handleSaveSalle = () => {
    ...
    console.log(data);
    axios
    .post(`${config.apiBaseUrl}/salles`, data ,{
      headers: {
  ...
  return (
    <div className={`flex min-h-screen flex-col body-font ${theme === 'dark' ? 'text-gray-400 bg-gray-900' : 'bg-gray-200 text-gray-800'}`}>
      ...
      <div className={`rounded-xl mb-8 border shadow  mx-auto  lg:col-span-8 xl:p-6 p-4 md:w-1/2 md:mt-4 justify-center ${theme === 'dark' ? 'border-gray-200 ' : 'border-gray-600 '}`}>          <div className='my-4'>
