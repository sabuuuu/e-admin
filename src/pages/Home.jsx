...
function Home() {
  return (
    <div className='h-screen bg-gray-900 font-body'>
      <Navbar />
      <Sidebar />
      <div className='h-3/4 w-full flex items-center justify-center bg-gray-900'>
        ...
        <Link to='/utilisateur' className='bg-gray-800 p-6  rounded-md text-center text-white hover:bg-gray-700'><img src={AjouterP} className='w-40 h-40      rounded-md mb-2' alt="" />Ajouter Enseignant</Link>
      </div>
    </div>
  )
}
